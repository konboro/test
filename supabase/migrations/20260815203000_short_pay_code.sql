...
-- Dropped and recreated rather than replaced: the signature gained a
-- payments_enabled column in 20260815140000, and `create or replace` cannot
-- change a return type. Keeping that column is not optional either — the public
-- page uses it to decide whether to offer a payment button at all.
