...
const PUBLIC_PREFIXES = [
  ...
  '/register',
  '/auth',
  // Marketing pages. They exist to be found by someone who has never signed
  // in, so gating them would hand a crawler a redirect to the login page and
  // index that instead.
  '/pricing',
  '/faq',
  ...
  '/odigos',
  // The privacy notice and the terms. A legal page behind a login is not a
  // legal page: the person most likely to want it is the debtor who received
  // a reminder and has no account here at all.
  '/aporrito',
  '/oroi',
  // Generated by Next from app/sitemap.ts and app/robots.ts.
  '/sitemap.xml',
  '/robots.txt',
