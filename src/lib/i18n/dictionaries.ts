...
const el = {
  ...
  bank: {
    ...
    autoSettled: 'Εξοφλήθηκαν αυτόματα',
    autoSettledHint: 'Αντιστοιχίστηκαν χωρίς παρέμβαση.',
    needsReview: 'Χρειάζονται επιβεβαίωση',
    needsReviewHint: 'Το ποσό ταιριάζει σε παραπάνω από ένα παραστατικό.',
    count: (n: number) => `${n} κινήσεις`,
    readOnly: 'Μόνο ανάγνωση — καμία πληρωμή δεν είναι δυνατή από εδώ.',
    emptyTitle: 'Καμία κίνηση',
    emptyBody: 'Μόλις διαβαστεί μια είσπραξη από τον λογαριασμό σας, θα εμφανιστεί εδώ.',
    colDate: 'Ημερομηνία',
    colPayer: 'Πληρωτής',
    colIban: 'IBAN',
...
const en: typeof el = {
  ...
  bank: {
    ...
    autoSettled: 'Settled automatically',
    autoSettledHint: 'Matched without anyone stepping in.',
    needsReview: 'Need confirming',
    needsReviewHint: 'The amount fits more than one invoice.',
    count: (n: number) => `${n} movements`,
    readOnly: 'Read-only — no payment can be made from here.',
    emptyTitle: 'No movements',
    emptyBody: 'As soon as a payment is read from your account, it shows up here.',
    colDate: 'Date',
    colPayer: 'Payer',
    colIban: 'IBAN',
