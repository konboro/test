    ...
    <footer className="border-t border-ink-200 py-8">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-4 px-4">
        ...
        <nav className="flex flex-wrap items-center gap-4">
          <Link href="/pricing" className="text-xs text-ink-500 transition hover:text-ink-800">
            {t.pricing.metaTitle}
          </Link>
          <Link href="/faq" className="text-xs text-ink-500 transition hover:text-ink-800">
            {t.faq.metaTitle}
          </Link>
        </nav>
